...
lazy mobile support by CreepyPSC
-------------------------------
...
function Hide()
    ...
    if game:GetService("UserInputService").TouchEnabled or game:GetService("UserInputService").GamepadEnabled then
	    RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by using the toggle button.", Duration = 7})
    else
...
-- [[ START NON-KEYBOARD TOGGLE ]] --

local userInput = game:GetService("UserInputService");
if userInput.TouchEnabled or userInput.GamepadEnabled then
	local ArrayToggle = Instance.new("ScreenGui")
	local Toggle = Instance.new("TextButton")
	local UICorner = Instance.new("UICorner")

	ArrayToggle.Name = "ArrayToggle"
	ArrayToggle.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
	ArrayToggle.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	Toggle.Name = "Toggle"
	Toggle.Parent = ArrayToggle
	Toggle.BackgroundColor3 = Color3.new(0.129412, 0.129412, 0.129412)
	Toggle.BorderSizePixel = 0
	Toggle.Position = UDim2.new(0.010852701, 0, 0.461059183, 0)
	Toggle.Size = UDim2.new(0.116279073, 0, 0.0778816193, 0)
	Toggle.Font = Enum.Font.GothamBold
	Toggle.Text = "Toggle DxrkHub"
